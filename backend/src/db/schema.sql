-- ════════════════════════════════════════════════════════════════════
-- ESQUEMA CONSOLIDADO — Plataforma de Empleo del Corredor Ecológico
-- ════════════════════════════════════════════════════════════════════
-- Archivo de conveniencia para importar manualmente (p. ej. en phpMyAdmin).
-- Refleja las migraciones de src/db/migrations/. La vía recomendada en
-- desarrollo es: npm run db:migrate  (y npm run db:seed para datos demo).
-- ════════════════════════════════════════════════════════════════════

CREATE DATABASE IF NOT EXISTS corredor_empleo
...
-- ── Habilidades (catálogo) + relación M:N ─────────────────────────────
...
INSERT INTO categorias (nombre) VALUES
  ('Agricultura y Medio Ambiente'), ('Turismo y Hotelería'), ('Construcción'),
  ('Comercio y Ventas'), ('Tecnología'), ('Educación'), ('Salud'),
  ('Servicios Generales'), ('Administración'), ('Transporte y Logística')
ON DUPLICATE KEY UPDATE nombre = VALUES(nombre);

INSERT INTO habilidades (nombre) VALUES
  ('Atención al cliente'), ('Trabajo en equipo'), ('Manejo de Excel'),
  ('Agricultura sostenible'), ('Guía turístico'), ('Ventas'),
  ('Conducción'), ('Cocina'), ('Carpintería'), ('Programación')
ON DUPLICATE KEY UPDATE nombre = VALUES(nombre);
